        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center w-full">
            ...
            <div className="md:col-span-7 flex flex-col gap-4">
              <span className="font-sans text-xs sm:text-sm font-bold text-[var(--color-navy)] tracking-[0.25em] uppercase opacity-75">
            ...
            <div className="md:col-span-5 flex flex-col items-center gap-4 justify-center">
              ...
              <div className="w-full bg-gradient-to-br from-[#FAFBFD] to-[#F3F4F6] border border-[#D9A05B]/30 rounded-2xl p-4 sm:p-6 shadow-sm flex flex-col items-center justify-center relative overflow-hidden group">
                <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#FFE296] to-transparent" />
                
                {/* Premium Product Bottle Image */}
                <div className="h-28 sm:h-36 w-full flex items-center justify-center mb-4 relative z-10">
                  <div className="absolute w-20 h-20 rounded-full bg-[var(--color-navy)]/5 filter blur-xl group-hover:scale-110 transition-transform duration-500" />
                  <img 
                    src="/images/isolated_bottle.webp" 
                    alt="Vedah Vital Ashwagandha Bottle" 
                    className="h-full object-contain filter drop-shadow-[0_12px_24px_rgba(10,25,47,0.18)] group-hover:scale-105 transition-transform duration-500"
                    loading="lazy"
                  />
                </div>

                <span className="font-sans text-xs sm:text-sm font-extrabold uppercase tracking-[0.3em] text-[var(--color-navy)] z-10">
                  Vedah Vital
                </span>
                <span className="font-sans text-[9px] font-bold tracking-[0.12em] text-gray-400 uppercase mt-1 z-10">
                  Ashwagandha Root Extract, KSM-66
                </span>
                <div className="w-12 h-[1px] bg-gradient-to-r from-transparent via-[var(--color-navy)]/35 to-transparent my-2.5 z-10" />
                <span className="font-sans text-[8px] font-bold tracking-[0.15em] text-[var(--color-navy)] uppercase opacity-75 text-center leading-normal z-10">
